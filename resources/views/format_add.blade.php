            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Codes and Standards </h4>
                    </div>
                    <div class="card-body">
                        <form class="custom-validation" action="{{ route('format.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="format_no" placeholder="Enter format number" value="{{ old('format_no') }}" required>
                                @error('format_no') 
                                    <span class="alert alert-danger text-center">{{ $message }}</span>
                                @enderror
                            </div>
