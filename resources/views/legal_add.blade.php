        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="custom-validation" action="{{ route('legal.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                         
                        
                            <div class="mb-3">
                                <label>Type of Document .</label>
                                <input type="text" class="form-control" name="type_of_document" placeholder="Enter Type of Document " value="{{ old('type_of_document') }}" required>
