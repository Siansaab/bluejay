            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('Procedures-add')}}"><i
                            class="icon-plus"></i>Add Procedures</a>
                    </div>
                    <div class="card-body">
                    ...
                    @endif
                        ...
                        <table id="datatable-buttons" class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($Procedures as $index => $Actss)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('Procedures.edit',['id' => $Actss->id])}} ">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('Procedures.delete',['id' => $Actss->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
