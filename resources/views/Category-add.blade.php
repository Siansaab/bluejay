                    ...
                    <div class="card-body">
                        <form class="custom-validation" action="{{ route('Category.store')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter the category" name="name" value="{{ old('name') }}" />
                                @error('name') 
                            ...
                            <div class="mb-3">
                                <label>Slug</label>
                                <input type="text" class="form-control" placeholder="Enter the category Slug" name="slug" value="{{ old('slug') }}"/>
                                @error('slug') 
                                    <span class="alert alert-danger text-center">{{ $message }}</span>
                                @enderror
                            </div>
