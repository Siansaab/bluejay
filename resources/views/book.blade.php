            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('book-add')}}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('book.edit',['id' => $Actss->id])}} ">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('book.delete',['id' => $Actss->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
