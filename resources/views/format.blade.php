            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('format-add')}}"><i
                            class="icon-plus"></i>Add format</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($Actss->word_file)
                                            <a href="{{ asset('storage/' . $Actss->word_file) }}" target="_blank">View word</a>
                                        @else
                                            No WORD
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('format.edit',['id' => $Actss->id])}} ">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('format.delete',['id' => $Actss->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
