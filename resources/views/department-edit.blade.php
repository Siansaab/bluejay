                    ...
                    <div class="card-body">
                        <form class="custom-validation" action="{{ route('department.update') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Type something" name="name" value="{{ $department->name }}" />
                                @error('name') 
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option value="deactive" {{ $department->status == 'deactive' ? 'selected' : '' }}>Deactive</option>
                                </select>
                                @error('status') 
                                    <span class="alert alert-danger text-center">{{ $message }}</span>
                                @enderror
