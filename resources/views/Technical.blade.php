            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('Technical-add')}}"><i
                            class="icon-plus"></i>Add Technical</a>
                    </div>
                    <div class="card-body">
                    ...
                    @endif
                        ...
                        <table id="datatable-buttons" class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($Technical as $index => $Actss)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('Technical.edit',['id' => $Actss->id])}} ">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('Technical.delete',['id' => $Actss->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
