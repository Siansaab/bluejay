        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="custom-validation" action="{{ route('code.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="issuing_authority" placeholder="Enter issuing authority" value="{{ old('issuing_authority') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="year_of_issue" placeholder="Enter year of issue" value="{{ old('year_of_issue') }}" min="1900" max="{{ date('Y') }}" required>
                                @error('year_of_issue') 
                                    <span class="alert alert-danger text-center">{{ $message }}</span>
                                @enderror
                            </div>
