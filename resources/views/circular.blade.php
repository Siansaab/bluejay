        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Circular</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Circular</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('circular-add')}}"><i
                            class="icon-plus"></i>Add Circular</a>
                    </div>
                    <div class="card-body">
                    ...
                    @endif
                        ...
                        <table id="datatable-buttons" class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($circular as $index => $Actss)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('circular.edit',['id' => $Actss->id])}} ">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('circular.delete',['id' => $Actss->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
