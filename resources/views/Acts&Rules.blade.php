        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Acts & Rules</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Acts & Rules</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{route('ActsRules_add')}}"><i
                            class="icon-plus"></i>Add Acts & Rules</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('acts.edit',['id' => $Actss->id])}} ">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('acts.delete',['id' => $Actss->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
