            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="{{ route('Category-add')}}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('Category.edit',['id' => $department->id])}}">
                                                <div class="item edit">
                                                    <i class="fas fa-edit"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('Category.delete', ['id' => $department->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
